    ...
    function handleQuizSubmission(quizData) {
        ...
        submitButton.addEventListener("click", function() {
            ...
            if (selectedChoices.length > 0) {
                ...
                if (isCorrect) {
                    resultElement.textContent = "Ai raspuns corect in aplicatia lui DragosFinalBoss!";
                    resultElement.style.color = "green";
                } else {
                    resultElement.textContent = `Ai raspuns gresit in aplicatia lui DragosFinalBoss! Răspunsul corect este ${currentQuestion.correctAnswers.join(", ")}.`;
                ...
                if (currentQuestionIndex < quizData.length) {
                    ...
                    resultElement.textContent = "Ai terminat testul Boss!";
                    counterElement.textContent = `Întrebări: ${quizData.length}/${quizData.length}`;
                    displayMistakes();
                }
            } else {
                resultElement.textContent = "Vă rugăm să selectați un răspuns in aplicatia lui DragosFinalBoss.";
